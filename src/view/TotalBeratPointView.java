 ...
 * @author bhadr
 */
public class TotalBeratPointView extends javax.swing.JFrame {

    /**
     * Creates new form TambahPenjemputanView
     */
    public TotalBeratPointView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Total Berat & Point - PickUp");
        ...
        jLabel2.setText("Total Berat & Point");
        ...
        riwayatTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Kurir", "Status", "Pelanggan", "Alamat", "Berat", "Point", "Tanggal"
            }
        ) {
    ...
    public void setTableData(List<Penjemputan> penjemputanList) {
        ...
        for (Penjemputan penjemputan : penjemputanList) {
            model.addRow(new Object[]{
                ...
                penjemputan.getBeratSampah() + " kg",
                penjemputan.getPoint(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TotalBeratPointView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TotalBeratPointView().setVisible(true);
            }
        });
    }
